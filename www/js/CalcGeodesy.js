...
})()(
  {
    1: [
      function(require, module, exports) {
        var LatLon = require("./node_modules/geodesy").LatLonEllipsoidal

        geodesyDistance = function(PointA, PointB) {
          let A = new LatLon(PointA.lat, PointA.lon, PointA.alt)
          let B = new LatLon(PointB.lat, PointB.lon, PointB.alt)
          return A.distanceTo(B)
        }

        geodesyAzimuth = function(PointA, PointB) {
          let A = new LatLon(PointA.lat, PointA.lon, PointA.alt)
          let B = new LatLon(PointB.lat, PointB.lon, PointB.alt)
          return A.initialBearingTo(B)
        }
      },
      { "./node_modules/geodesy": 8 }
    ],
    2: [
      function(require, module, exports) {
        /* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  */
      ...
      function(require, module, exports) {
        ...
        LatLon.datum = {
          ...
          NAD83: {
            ...
            transform: [1.004, -1.91, -0.515, -0.0015, 0.0267, 0.00034, 0.011]
          },
          NTF: {
        ...
        LatLon.prototype.toString = function(format, dp) {
          return (
            Dms.toLat(this.lat, format, dp) +
            ", " +
            Dms.toLon(this.lon, format, dp)
          )
        }
        ...
        /* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  */
        if (typeof module != "undefined" && module.exports)
          (module.exports = LatLon), (module.exports.Vector3d = Vector3d) // ≡ export { LatLon as default, Vector3d }
      },
      { "./dms.js": 2, "./vector3d.js": 11 }
    ],
    4: [
      function(require, module, exports) {
        /* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  */
         ...
         */
        LatLon.prototype.destinationPoint = function(
          distance,
          bearing,
          radius
        ) {
        ...
        LatLon.intersection = function(p1, brng1, p2, brng2) {
          if (!(p1 instanceof LatLon))
            throw new TypeError("p1 is not LatLon object")
          if (!(p2 instanceof LatLon))
            throw new TypeError("p2 is not LatLon object")
         ...
         */
        LatLon.prototype.crossTrackDistanceTo = function(
          pathStart,
          pathEnd,
          radius
        ) {
          if (!(pathStart instanceof LatLon))
            throw new TypeError("pathStart is not LatLon object")
          if (!(pathEnd instanceof LatLon))
            throw new TypeError("pathEnd is not LatLon object")
         ...
         */
        LatLon.prototype.alongTrackDistanceTo = function(
          pathStart,
          pathEnd,
          radius
        ) {
         ...
         */
        LatLon.prototype.rhumbDestinationPoint = function(
          distance,
          bearing,
          radius
        ) {
        ...
        /* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  */
        if (typeof module != "undefined" && module.exports)
          module.exports = LatLon // ≡ export default LatLon
      },
      { "./dms.js": 2 }
    ],
    5: [
      function(require, module, exports) {
        ...
        LatLon.prototype.greatCircle = function(bearing) {
          ...
          var x =
            Math.sin(λ) * Math.cos(θ) - Math.sin(φ) * Math.cos(λ) * Math.sin(θ)
          var y =
            -Math.cos(λ) * Math.cos(θ) - Math.sin(φ) * Math.sin(λ) * Math.sin(θ)
         ...
         */
        LatLon.prototype.intermediatePointOnChordTo = function(
          point,
          fraction
        ) {
          if (!(point instanceof LatLon))
         ...
         */
        LatLon.intersection = function(
          path1start,
          path1brngEnd,
          path2start,
          path2brngEnd
        ) {
          if (!(path1start instanceof LatLon))
            throw new TypeError("path1start is not LatLon object")
          if (!(path2start instanceof LatLon))
            throw new TypeError("path2start is not LatLon object")
          if (!(path1brngEnd instanceof LatLon) && isNaN(path1brngEnd))
            throw new TypeError("path1brngEnd is not LatLon object or bearing")
          if (!(path2brngEnd instanceof LatLon) && isNaN(path2brngEnd))
            throw new TypeError("path2brngEnd is not LatLon object or bearing")
          ...
          switch (path1def + "+" + path2def) {
            ...
            case "endpoint+endpoint": // select nearest intersection to mid-point of all points
              var mid = p1
                .plus(p2)
                .plus(path1brngEnd.toVector())
                .plus(path2brngEnd.toVector())
        ...
        LatLon.prototype.crossTrackDistanceTo = function(
          ...
          var gc =
            pathBrngEnd instanceof LatLon // (note JavaScript is not good at method overloading)
      ...
      function(require, module, exports) {
        ...
        LatLon.prototype.finalBearingOn = function(distance, initialBearing) {
          return Number(
            this.direct(
              Number(distance),
              Number(initialBearing)
            ).finalBearing.toFixed(7)
          ...
          do {
            ...
            λ =
              ...
              (1 - C) *
                ...
                sinα *
                (σ +
                  C * sinσ * (cos2σM + C * cosσ * (-1 + 2 * cos2σM * cos2σM)))
    ...
    7: [
      function(require, module, exports) {
        ...
        function Mgrs(zone, band, e100k, n100k, easting, northing, datum) {
          // allow instantiation without 'new'
          if (!(this instanceof Mgrs))
            return new Mgrs(zone, band, e100k, n100k, easting, northing, datum)

          if (datum === undefined) datum = LatLon.datum.WGS84 // default if not supplied

          if (!(1 <= zone && zone <= 60))
            throw new Error("Invalid MGRS grid reference (zone ‘" + zone + "’)")
          if (band.length != 1)
            throw new Error("Invalid MGRS grid reference (band ‘" + band + "’)")
          if (Mgrs.latBands.indexOf(band) == -1)
            throw new Error("Invalid MGRS grid reference (band ‘" + band + "’)")
          if (e100k.length != 1)
            throw new Error(
              "Invalid MGRS grid reference (e100k ‘" + e100k + "’)"
            )
          if (n100k.length != 1)
            throw new Error(
              "Invalid MGRS grid reference (n100k ‘" + n100k + "’)"
            )
        ...
        Utm.prototype.toMgrs = function() {
          if (isNaN(this.zone + this.easting + this.northing))
            throw new Error("Invalid UTM coordinate ‘" + this.toString() + "’")
        ...
        Mgrs.prototype.toUtm = function() {
          ...
          var nBand =
            Math.floor(new LatLon(latBand, 0).toUtm().northing / 100e3) * 100e3
        ...
        Mgrs.parse = function(mgrsGridRef) {
          ...
          if (!mgrsGridRef.match(/\s/)) {
            ...
            mgrsGridRef =
              mgrsGridRef.slice(0, 3) + " " + mgrsGridRef.slice(3, 5) + " " + en // insert spaces
          }

          // match separate elements (separated by whitespace)
          mgrsGridRef = mgrsGridRef.match(/\S+/g)

          if (mgrsGridRef == null || mgrsGridRef.length != 4)
        ...
        Mgrs.prototype.toString = function(digits) {
          ...
          if ([2, 4, 6, 8, 10].indexOf(digits) == -1)
          ...
          var nRounded = Math.floor(
            this.northing / Math.pow(10, 5 - digits / 2)
          )
        ...
        /* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  */
        if (typeof module != "undefined" && module.exports)
          module.exports = Mgrs // ≡ export default Mgrs
      },
      { "./latlon-ellipsoidal.js": 3, "./utm.js": 10 }
    ],
    8: [
      function(require, module, exports) {
        /* npm main module */
      ...
      },
      {
        "./dms.js": 2,
        "./latlon-ellipsoidal.js": 3,
        "./latlon-spherical.js": 4,
        "./latlon-vectors.js": 5,
        "./latlon-vincenty.js": 6,
        "./mgrs.js": 7,
        "./osgridref.js": 9,
        "./utm.js": 10,
        "./vector3d.js": 11
      ...
      function(require, module, exports) {
        ...
        OsGridRef.prototype.toString = function(digits) {
          ...
          if (digits == 0) {
            ...
            var ePad =
              ("000000" + eInt).slice(-6) +
              (eDec > 0 ? eDec.toFixed(3).slice(1) : "")
            var nPad =
              (nInt < 1e6 ? ("000000" + nInt).slice(-6) : nInt) +
              (nDec > 0 ? nDec.toFixed(3).slice(1) : "")
            return ePad + "," + nPad
          }
          ...
          var l1 =
            19 - n100k - ((19 - n100k) % 5) + Math.floor((e100k + 10) / 5)
          var l2 = (((19 - n100k) * 5) % 25) + (e100k % 5)

          // compensate for skipped 'I' and build grid letter-pairs
          if (l1 > 7) l1++
          if (l2 > 7) l2++
          var letterPair = String.fromCharCode(
            l1 + "A".charCodeAt(0),
            l2 + "A".charCodeAt(0)
          )
    ...
    10: [
      function(require, module, exports) {
        ...
        function Utm(
          ...
          if (!hemisphere.match(/[NS]/i))
            throw new Error("Invalid UTM hemisphere " + hemisphere)
        ...
        LatLon.prototype.toUtm = function() {
          ...
          var A =
            (a / (1 + n)) * (1 + (1 / 4) * n2 + (1 / 64) * n4 + (1 / 256) * n6) // 2πA is the circumference of a meridian
        ...
        Utm.prototype.toLatLonE = function() {
          ...
          var β = [
            null, // note β is one-based array (6th order Krüger expressions)
            (1 / 2) * n -
              (2 / 3) * n2 +
              (37 / 96) * n3 -
              (1 / 360) * n4 -
          ...
          do {
            var σi = Math.sinh(
              e * Math.atanh((e * τi) / Math.sqrt(1 + τi * τi))
            )
    ...
    11: [
      function(require, module, exports) {
        ...
        Vector3d.prototype.angleTo = function(v, n) {
          if (!(v instanceof Vector3d))
            throw new TypeError("v is not Vector3d object")
          if (!(n instanceof Vector3d || n == undefined))
        ...
        /* - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -  */
        if (typeof module != "undefined" && module.exports)
          module.exports = Vector3d // ≡ export default Vector3d
      },
      {}
    ]
  },
